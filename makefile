...
deploy:
	@forge script script/DeployJatEngine.s.sol:DeployJatEngine $(NETWORK_ARGS)

createValues:
	@forge script script/interaction.s.sol:SimulateDepositsAndBorrowings $(NETWORK_ARGS)
